...
<div class="content-body" style="min-height: 788px;">
   ...
   <div class="form-group">
            <label class="info-title">Adres</label>
        <textarea name="adress" class="form-control" rows="4" id="comment">
            {{ $footer->adress }}
        </textarea>
            @error('adress')
         ...
         <input type="email" name="email" class="form-control input-default " value="{{ $footer->email }}"  >
            ...
            @enderror
               ...
               <div class="form-group">
                <label class="info-title">Telefon No</label>
         ...
         <input type="text" name="linkedin" class="form-control input-default " value="{{ $footer->linkedin }}"  >
            @error('youtube')
            <span class="text-danger">{{ $message }}</span>
            @enderror

            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Stajları Düzenle </h4>
                    </div>
                    <div class="card-body">
...
<form method="post" action="{{ route('application.update') }}" enctype="multipart/form-data">
 ...
 <input type="text" name="short_title" class="form-control input-default " value="{{ $applications->short_title }}"  >
    @error('short_title')
...
<input type="file" name="small_img" class="custom-file-input" id="image">
    ...
    <div class="form-group">
       <img id="showImage" src="{{ asset($applications->small_img)  }}" style="width: 100px; height: 100px;">
    </div>


<div class="form-group">
        <label class="info-title">Uzun Başlık </label>
 <input type="text" name="long_title" class="form-control input-default " value="{{ $applications->long_title }}" >
    @error('long_title')
    <span class="text-danger">{{ $message }}</span>
    @enderror
...
<div class="form-group">
 ...
 <input type="text" name="total_duration" class="form-control input-default "  value="{{ $applications->total_duration }}">
 ...
 <input type="text" name="total_lecture" class="form-control input-default " value="{{ $applications->total_lecture }}"  >
    @error('total_lecture')
    <span class="text-danger">{{ $message }}</span>
    @enderror
 ...
 <input type="text" name="total_application" class="form-control input-default "  value="{{ $applications->total_application }}" >
...
<div class="form-group">
   ...
   <input type="submit" class="btn btn-success" value="Stajı Kaydet">

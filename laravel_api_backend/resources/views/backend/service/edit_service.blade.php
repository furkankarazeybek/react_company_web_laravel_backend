                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Hizmetleri Düzenle</h4>
                            </div>
                            <div class="card-body">
                  ...
                  <form method="post" action="{{ route('service.update') }}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" value={{ $services->id }} >
                      ...
                      <div class="form-group">
                          <label class="info-title">Hizmet Adı</label>
                      ...
                      <div class="form-group">
                        <label class="info-title">Hizmet Açıklaması</label>

                        <textarea class="form-control" name="service_description" rows="4" id="comment"> {{ $services->service_description }}
                        </textarea>

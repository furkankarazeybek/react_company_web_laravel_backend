                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Projeleri Düzenle</h4>
                            </div>
                            <div class="card-body">
                  ...
                  <form method="post" action="{{ route('project.update') }}" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="form-group">
                          <label class="info-title">Proje Adı</label>
                      ...
                      <div class="form-group">
                        ...
                        <textarea maxlength="50" class="form-control" name="project_description" rows="4" id="comment">{{ $project->project_description }}
                        </textarea>
                    ...
                    <div class="form-group">
                        <label class="info-title">Proje Ayrıntıları/Özellikleri</label>
                    ...
                    <div class="form-group">
                        <label class="info-title">Ön İzleme Bilgisi</label>
                      ...
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">1. Resim Yükle</span>
                        </div>
                        <div class="custom-file">
                            <input type="file" name="img_one" class="custom-file-input" id="image">
                            <label class="custom-file-label">1. Resim Seç</label>
                        </div>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">2. Resim Yükle</span>
                        </div>
                        <div class="custom-file">
                            <input type="file" name="img_two" class="custom-file-input" id="image2">
                            <label class="custom-file-label">2. Resim Seç</label>
                        </div>
                    </div>

            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tüm Bilgiler</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-responsive-md">
                                <thead>
                                    <tr>
                                        ...
                                        <th><strong>Hakkımızda Bilgileri</strong></th>
                                        <th><strong>Veri Koruma İlkeleri</strong></th>
                                        <th><strong>Şartlar ve Koşullar</strong></th>
                                        <th><strong>Gizlilik Politikası</strong></th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                             ...
                             <tr>
                                        ...
                                        <td>{{ Str::limit($item->data_protect, 20, '..') }}</td>
